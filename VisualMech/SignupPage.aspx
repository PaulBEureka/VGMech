            ...
            <div class="row align-self-center signup_rectangle m-auto signup_padding">
                <asp:Panel ID="Panel1" runat="server" Height="194px" HorizontalAlign="Center">
                    <div>                        
                        ...
                        <h4 style="color: white; padding-bottom:10px; text-align:left">New Username: <asp:TextBox ID="TextBox2" runat="server" Width="348px"></asp:TextBox></h4>                
                        <h4 style="color: white; padding-bottom:10px; text-align:left">New Password: <asp:TextBox ID="TextBox3" runat="server" Width="348px"></asp:TextBox></h4>
                        <h4 style="color: white; padding-bottom:10px; text-align:left">Confirm Password: <asp:TextBox ID="TextBox1" runat="server" Width="348px"></asp:TextBox></h4>
                        <asp:Panel ID="Panel2" runat="server" >
                            <asp:Button class="signup_button" ID="Button2" runat="server" Text="Register" OnClick="Button2_Click"/>
                        </asp:Panel>
                        <br />
